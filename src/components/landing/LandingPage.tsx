...
export function LandingPage({ onGetStarted, onViewDemo }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            >
              <div className="w-10 h-10 bg-linear-to-br from-blue-600 via-blue-600 to-purple-600 rounded-lg flex items-center justify-center shadow-lg">
                <Activity className="w-6 h-6 text-white" />
              </div>
              <span className="text-gray-900 text-xl tracking-tight font-bold">
                KhoKho Arena
              </span>
            </motion.div>
              ...
              {["features", "how-it-works", "pricing", "testimonials"].map(
                (item) => (
                  <button
                    ...
                    className="text-gray-600 hover:text-blue-600 transition-all duration-300 relative group capitalize"
                  >
                  ...
                  <div className="flex flex-col gap-6 mt-8">
                    {[
                      ...
                      <button
                        ...
                        className="text-lg text-left font-medium text-gray-700 hover:text-blue-600 capitalize"
                      >
                        {item.replace(/-/g, " ")}
                      </button>
                    ))}
      ...
      <section className="min-h-screen pt-16 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-blue-50 via-white to-purple-50 relative overflow-hidden flex items-center">
        ...
        <div className="max-w-7xl mx-auto relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="space-y-6">
                <motion.div
                  ...
                  transition={{ duration: 0.5, delay: 0.2 }}
                >
                  <Badge className="bg-linear-to-r from-blue-500 to-purple-500 text-white border-0 px-4 py-1.5 mb-6">
                    <Sparkles className="w-3 h-3 mr-1.5" />
                    Live Tournament Management
                  </Badge>
                </motion.div>

                <h1 className="text-4xl md:text-5xl text-gray-900 leading-tight tracking-tight font-extrabold">
                  The Complete Live Scoring & Tournament Management System for{" "}
                  <span className="bg-linear-to-r from-blue-600 to-purple-600 text-transparent bg-clip-text">
                    Kho-Kho
                  </span>
                </h1>
                <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                  Run tournaments smoothly, score matches accurately, and give
                  your audience a world-class live viewing experience — all in
                  one platform.
                </p>
              </div>
              ...
              >
                <Button
                  size="lg"
                  className="bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white h-14 px-8 text-lg shadow-xl shadow-blue-500/30 transition-all hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/40"
                  onClick={onGetStarted}
                >
                  Get a Demo
            ...
            >
              <div className="absolute -inset-4 bg-linear-to-r from-blue-400 to-purple-400 rounded-2xl opacity-20 blur-2xl"></div>
              <Card className="relative border-2 border-gray-200 shadow-2xl overflow-hidden">
                <div className="bg-linear-to-br from-blue-600 to-purple-600 p-4 text-white">
                ...
                <CardContent className="p-6 space-y-6">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    >
                      ...
                      <p className="text-4xl text-gray-900 font-bold">14</p>
                    </motion.div>
                    <motion.div
                    ...
                    >
                      ...
                      <p className="text-4xl text-gray-900 font-mono">08:45</p>
                    </motion.div>
                    <motion.div
                    ...
                    >
                      ...
                      <p className="text-4xl text-gray-900 font-bold">10</p>
                    </motion.div>
                  </div>
      ...
      {/* Who It's For Strip with linear transition */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-linear-to-b from-purple-50/50 via-white to-gray-50 border-y border-gray-100">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-3">
              Made for Everyone Involved in Kho-Kho
            </h2>
            <p className="text-gray-600">
              A complete platform for the entire sports ecosystem
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                desc: "Create and manage tournaments with ease",
              ...
              },
              {
                icon: UserCheck,
                title: "Match Scorers",
                desc: "Fast and accurate live match scoring",
              ...
              },
              {
                icon: Eye,
                title: "Viewers & Fans",
                desc: "Watch live matches and follow scores",
              ...
              },
              {
                icon: Users,
                title: "Coaches & Teams",
                desc: "Track player stats and team performance",
              ...
              >
                <Card
                  className={`border-gray-200 ${item.hoverBorder} hover:shadow-xl transition-all duration-200`}
                >
                  <CardContent className="p-6 text-center">
                    <div
                      className={`w-16 h-16 bg-gradient-to-br ${item.gradient} rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg`}
                    >
      ...
      <section
        id="features"
        className="min-h-screen py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 via-white to-blue-50/30 flex items-center"
      >
              ...
              <Card className="border-2 border-gray-200 hover:border-blue-400 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-200 h-full">
                <CardContent className="p-8">
                  ...
                  <p className="text-gray-600 mb-6">
                    Manage Events with Total Control
                  </p>
                  <ul className="space-y-3 mb-6">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-700">
                        Create tournaments, teams & fixtures
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                  ...
                  <Button
                    className="w-full bg-linear-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200"
                    onClick={onGetStarted}
                  >
            ...
            >
              <Card className="border-2 border-gray-200 hover:border-purple-400 hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-200 h-full">
                <CardContent className="p-8">
                  ...
                  <p className="text-gray-600 mb-6">
                    The Fastest, Easiest Kho-Kho Scoring Interface
                  </p>
                  <ul className="space-y-3 mb-6">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-purple-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-700">
                        One-tap attacker, defender & event selection
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-purple-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-700">
                        Turn-wise timer with per-time tracking
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-purple-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-700">
                        Substitutions, cards, warnings
                      </span>
                    </li>
                  </ul>
                  <Button
                    className="w-full bg-linear-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200"
                    onClick={onGetStarted}
                  >
            ...
            >
              <Card className="border-2 border-gray-200 hover:border-green-400 hover:shadow-2xl hover:shadow-green-500/20 transition-all duration-200 h-full">
                <CardContent className="p-8">
                  ...
                  <p className="text-gray-600 mb-6">
                    Watch Live Kho-Kho Like Never Before
                  </p>
                  <ul className="space-y-3 mb-6">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-700">
                        Live scoreboard & Real-time action feed
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
      ...
      {/* How It Works - Full Screen Height */}
      <section
        id="how-it-works"
        className="min-h-screen py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50/30 via-white to-purple-50/30 flex items-center"
      >
        <div className="max-w-7xl mx-auto w-full">
          <motion.div
            className="text-center mb-16"
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-transparent bg-clip-text mb-6">
            ...
            {[
              {
                ...
                desc: "Organizer sets up event, teams, and fixtures.",
                gradient: "from-blue-500 to-blue-600",
              ...
              },
              {
                ...
                desc: "Scorers get their matches and log in.",
                gradient: "from-purple-500 to-purple-600",
              ...
              },
              {
                ...
                desc: "Real-time scoring with smart rules.",
              ...
              {
                icon: BarChart3,
                title: "View & Publish Results",
                desc: "Admin verifies, viewers see results.",
                gradient: "from-orange-500 to-orange-600",
              ...
              >
                <div
                  className={`w-32 h-32 bg-gradient-to-br ${step.gradient} rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl ${step.shadow}`}
                >
      ...
      <section
        id="testimonials"
        className="min-h-screen py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-pink-50/30 via-white to-gray-50 flex items-center"
      >
        <div className="max-w-7xl mx-auto w-full">
          <motion.div
            className="text-center mb-16"
            ...
            {[
              {
                ...
                quote:
                  "Made it so easy to run our college Kho-Kho tournament. The live scoring was seamless and parents loved watching online.",
              },
              {
                name: "Priya Sharma",
                role: "Sports Coordinator",
                quote:
                  "Live scoring was smooth, and players loved seeing their stats immediately after matches. Highly recommend!",
              },
              {
                name: "Anil Desai",
                role: "District Sports Officer",
                quote:
                  "The admin panel made tournament management a breeze. Everything from team creation to results in one place.",
              },
      ...
      >
        <div className="max-w-7xl mx-auto w-full">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 text-transparent bg-clip-text mb-6">
            ...
            >
              <Card className="border-2 border-blue-500 hover:shadow-3xl hover:shadow-blue-500/30 transition-all duration-200 relative h-full bg-gradient-to-br from-blue-50 to-purple-50">
                ...
                <CardContent className="p-8">
                  ...
                  <div className="mb-6">
                    <span className="text-5xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 text-transparent bg-clip-text">
                      ₹2,999
                    </span>
                    <span className="text-gray-600">/month</span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-600 mb-4">
                Smart tournament management and live scoring for Kho-Kho. Built
                by sports enthusiasts for the community.
              </p>
