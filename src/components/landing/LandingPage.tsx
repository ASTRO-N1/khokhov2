        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            >
              ...
              <span className="text-gray-900 text-xl tracking-tight">
                KhoKho Arena
              </span>
            </motion.div>
            <motion.div
        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          >
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Real-time scoring, instant updates, and comprehensive match
              insights
            </p>
          </motion.div>
            ...
            >
              <Card className="border-2 border-blue-500 hover:shadow-3xl hover:shadow-blue-500/30 transition-all duration-200 relative h-full bg-gradient-to-br from-blue-50 to-purple-50">
                ...
                <CardContent className="p-8">
                  ...
                  <div className="mb-6">
                    <span className="text-5xl bg-gradient-to-r from-blue-600 to-purple-600 text-transparent bg-clip-text">
                      ₹2,999
                    </span>
                    <span className="text-gray-600">/month</span>
                  </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 relative overflow-hidden">
        ...
        >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Join hundreds of organizers who trust KhoKho Arena for their
            tournaments
          </motion.p>
          <motion.div
