...
export function TournamentDetailsPage({
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (matchesError) {
        toast.error("Failed to fetch matches for this tournament.");
      } else {
      ...
      // A more complex query would be needed to get only teams in this tournament
      // For now, we'll fetch all teams for simplicity
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm">{matches.length} Scheduled</p>
                  </div>
                </div>
              </div>
            </CardContent>
                    ...
                    {standings.map((team, index) => (
                      ...
                      >
                        <TableCell className="text-center">
                          {index === 0 && (
                            <Trophy className="w-4 h-4 text-yellow-600 inline mr-1" />
                          )}
                          {index + 1}
                        </TableCell>
                        <TableCell>
